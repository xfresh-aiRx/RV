...
# endif
  ...
  // write method
  bool /*@classname*/::write(ioHandler& handler,const bool complete) const {
    bool b(true);
    ...
    if (b) {
      // TODO: write the state of the classifier here
    }
  ...
  // read method
  bool /*@classname*/::read(ioHandler& handler,const bool complete) {
    bool b(true);
    ...
    if (b) {
      // TODO: read the state of the classifier here
    }
  ...
  bool /*@classname*/::train(const dmatrix& data,
    ...
    //@TODO after implementing the training don't forget to set the
    //outTemplate. The method setOutputTemplate defined in
    //supervisedClassifier can be helpful for this.
