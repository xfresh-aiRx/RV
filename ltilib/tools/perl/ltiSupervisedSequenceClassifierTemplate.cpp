...
# endif
  ...
  bool /*@classname*/::train(const std::vector< sequence<dvector> > input,
                             const ivector& ids) {
  ...
  // method from direct subclass of classifier instead.
  // In this case delete. Otherwise comment!

  bool /*@classname*/::classify(const sequence<dvector>& observations,
                                outputVector& result) {
