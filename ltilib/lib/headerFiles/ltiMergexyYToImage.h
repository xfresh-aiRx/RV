 ...
 * file .......: ltiMergexyYToImage.h
 * authors ....: Pablo Alvarado, Stefan Syberichs, Thomas Rusert
 * organization: LTI, RWTH Aachen
 * creation ...: 19.04.99
 * revisions ..: $Id: ltiMergexyYToImage.h,v 1.1 2003/11/14 16:07:22 alvarado Exp $
 */

#ifndef _LTI_MERGE_XYY_TO_IMAGE_H_
#define _LTI_MERGE_XYY_TO_IMAGE_H_
...
namespace lti {
   ...
   * @ingroup gColor
   */
  class mergexyYToImage : public mergeImage {
  public:
