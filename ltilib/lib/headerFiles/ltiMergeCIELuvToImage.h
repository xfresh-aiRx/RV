 ...
 * file .......: ltiMergeCIELuvToImage.h
 * authors ....: Pablo Alvarado, Stefan Syberichs, Thomas Rusert
 * organization: LTI, RWTH Aachen
 * creation ...: 19.04.99
 * revisions ..: $Id: ltiMergeCIELuvToImage.h,v 1.1 2003/11/14 16:07:21 alvarado Exp $
 */

#ifndef _LTI_MERGE_CIELUV_TO_IMAGE_H_
#define _LTI_MERGE_CIELUV_TO_IMAGE_H_
...
namespace lti {
   ...
   * @ingroup gColor
   */
  class mergeCIELuvToImage : public mergeImage {
  ...
  protected:
     ...
     * @see splitImageToCIELuv operation
     */
