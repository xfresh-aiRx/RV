 ...
 * creation ...: 27.3.2002
 * revisions ..: $Id: ltiSchieleCrowley6DFeature.cpp,v 1.13 2005/10/28 15:56:42 doerfler Exp $
 */
...
# else
    ...
    localFeatureExtractor::parameters& 
	  ...
	  //localFeatureExtractor::parameters::copy; //AMei
	  &lti::localFeatureExtractor::parameters::copy;
    (this->*p_copy)(other);
    globalFeatureExtractor::parameters& 
      (globalFeatureExtractor::parameters::* p_copy2)
      (const globalFeatureExtractor::parameters&) =
      //globalFeatureExtractor::parameters::copy; /AMei
	  &lti::globalFeatureExtractor::parameters::copy;
    (this->*p_copy2)(other);
# endif
