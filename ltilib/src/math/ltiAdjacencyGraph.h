 ...
 * creation ...: 01.07.2003
 * revisions ..: $Id: ltiAdjacencyGraph.h,v 1.13 2005/06/16 12:37:33 doerfler Exp $
 */
...
#pragma message("Insufficient C++ Template Support for lti::adjacencyGraph.")
...
namespace lti {
   ...
   * <b>IO</b>
   *
   * The adjacency graphs are mathObjects, and therefore are
  ...
  class adjacencyGraph : public mathObject {
  public:
    /**
  ...
  protected:
    ...
    public:
      ...
      typedef typename std::map<id_type,
              typename adjacencyGraph<N,W,D,F,E>::entry_type>::iterator entry_iterator;
...
#     endif
     ...
     * 
     * @param it iterator to the edge
     * @return the weith of the edge or edge_traits::Invalid if edge does not exist
     */
