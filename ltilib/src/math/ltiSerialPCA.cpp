 ...
 * file .......: ltiSerialPCA.cpp
 * authors ....: Pablo Alvarado, Jochen Wickel
 * organization: LTI, RWTH Aachen
 * creation ...: 06.02.03
 * revisions ..: $Id: ltiSerialPCA.cpp,v 1.3 2003/10/30 13:01:58 sltilib Exp $
 */
...
#include "ltiSerialPCA_template.h"

namespace lti {
  // explicit instantiations

  template class serialPCA<double>;
  template class serialPCA<float>;
}
