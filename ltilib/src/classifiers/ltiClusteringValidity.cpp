 ...
 * creation ...: 4.4.2002
 * revisions ..: $Id: ltiClusteringValidity.cpp,v 1.12 2005/11/24 15:01:45 doerfler Exp $
 */
...
#define QUALIFIER &lti::dunnIndex::
    ...
    switch (param.diameterMeasure) {
      case parameters::Standard:
        diamFunc=QUALIFIER &lti::clusteringValidity::getStandardDiameter; // AMei
        break;
      case parameters::Average:
        diamFunc=QUALIFIER &lti::clusteringValidity::getAverageDiameter; // AMei
        break;
      case parameters::Centroid:
        diamFunc=QUALIFIER &lti::clusteringValidity::getAverageToCentroidDiameter; //AMei
        break;
      default:
        diamFunc=QUALIFIER &lti::clusteringValidity::getStandardDiameter; //AMei
    ...
    switch (param.distanceMeasure) {
      case parameters::Minimum:
        distFunc=QUALIFIER &lti::clusteringValidity::getMinimumDistance; //AMei
        break;
      case parameters::Maximum:
        distFunc=QUALIFIER &lti::clusteringValidity::getMaximumDistance; //AMei
        break;
      case parameters::Mean:
        distFunc=QUALIFIER &lti::clusteringValidity::getAverageDistance; //AMei
        break;
      case parameters::Centroids:
        distFunc=QUALIFIER &lti::clusteringValidity::getCentroidDistance; //AMei
        break;
      case parameters::Interpoint:
        distFunc=QUALIFIER &lti::clusteringValidity::getAverageInterpointDistance; //AMei
        break;
      default:
        distFunc=QUALIFIER &lti::clusteringValidity::getAverageDistance; //AMei
    ...
    for (i=0; i<nbClusters; i++) {
      for (j=i+1; j<nbClusters; j++) {
        if (distFunc==QUALIFIER &lti::clusteringValidity::getCentroidDistance) { //AMei
