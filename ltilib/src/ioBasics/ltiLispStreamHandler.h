 ...
 * creation ...: 7.12.2000
 * revisions ..: $Id: ltiLispStreamHandler.h,v 1.7 2004/06/03 09:47:10 alvarado Exp $
 */
...
namespace lti {
  /**
   * The lispStreamHandler class offer an interface for the functor parameters
   ...
   * a decimal point won't be readed correctly, because the method will be
