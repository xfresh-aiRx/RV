 ...
 * creation ...: 07.04.99
 * revisions ..: $Id: ltiTimer.cpp,v 1.13 2005/06/22 15:42:10 doerfler Exp $
 */
...
#   endif
  ...
  buf.append(sTemp);
  buf.append(" ");
  sprintf(s,"%i",pST->wDay);
  buf.append(s);
  buf.append(" ");
  sprintf(s,"%i",pST->wHour);
  buf.append(s);
  buf.append(":");
  sprintf(s,"%i",pST->wMinute);
  buf.append(s);
  buf.append(":");
  sprintf(s,"%i",pST->wSecond);
  buf.append(s);
  buf.append(" ");
  sprintf(s,"%i",pST->wYear);
  buf.append(s);
  return buf;
