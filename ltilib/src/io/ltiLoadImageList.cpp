 ...
 * creation ...: 22.11.2002
 * revisions ..: $Id: ltiLoadImageList.cpp,v 1.24 2005/11/24 15:01:27 doerfler Exp $
 */
...
# endif
  ...
  // default constructor
   // GEÄNDERT VON CARSTEN !!!
  // GEÄNDERT VON CARSTEN !!!
  // GEÄNDERT VON CARSTEN !!!

  loadImageList::loadImageList()
   // : ioFunctor(), fileNames(0), iter(0), emptyDummy(""), iLoader() {					//CF: ALT
	: ioFunctor(), fileNames(0), iter(fileNames.begin()), emptyDummy(""), iLoader() {	//CF: NEU
  ...
  // constructor
  loadImageList::loadImageList(const std::string& name, parameters::eOperationMode mode)
  //: ioFunctor(), fileNames(0), iter(0), emptyDummy(""), iLoader() {					//CF: ALT
	: ioFunctor(), fileNames(0), iter(fileNames.begin()), emptyDummy(""), iLoader() {	//CF: NEU
