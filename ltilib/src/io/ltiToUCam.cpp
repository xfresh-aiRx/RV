 ...
 * creation ...: 24.04.01
 * revisions ..: $Id: ltiToUCam.cpp,v 1.24 2005/06/16 12:37:11 doerfler Exp $
 */
...
// this type is required by <linux/videodev.h> but is defined in
// <linux/types.h> only if __KERNEL__ is defined (which is usually not
// the case.  So let's define it here...
#ifndef __KERNEL__
...
#   if defined(_LTI_DEBUG) && _LTI_DEBUG >= 4
    cout << "toUCam::destructor called and camera freed" << endl;
#   endif
  }
...
#   endif
  ...
  bool toUCam::setCameraParameters() {
    ...
    if ((lastUsedParams.size != param.size) ||
      ...
      videoWin.width = param.size.x;
      videoWin.height = param.size.y;
...
#     if defined(_LTI_DEBUG) && _LTI_DEBUG >= 4
      ...
      cout << "Window properties after set:" << endl
           << "  x = " << videoWin.x << endl
           << "  y = " << videoWin.y << endl
...
#     if defined(_LTI_DEBUG) && _LTI_DEBUG >= 4
      ...
      cout << "Image properties after set:" << endl
...
#     if defined(_LTI_DEBUG) && _LTI_DEBUG >=4
      ...
      cout << "  awb:" << pwcwb.mode << endl;
      cout << "  red gain:" << pwcwb.read_red << endl;
      cout << "  blue gain:" << pwcwb.read_blue << endl;
#     endif
